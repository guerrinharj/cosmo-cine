        ...
        <div className="pt-20 pb-10 bg-black text-white min-h-screen">
            ...
            {isAuthenticated && (
                <>
                    ...
                    <Link
                        href="/filmes/create"
                        className="paralucent hidden md:flex fixed bottom-16 right-6 border border-white bg-black text-black text-2xl rounded-full w-12 h-12 items-center justify-center shadow-lg hover:bg-gray-300 transition z-40"
